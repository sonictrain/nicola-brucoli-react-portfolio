...
const Footer = () => {
    return (
        <div className="flex gap-4">
            {/* IconButton component GITHUB */}
            <IconButton
                onClick={() => window.open('https://www.github.com/sonictrain', '_blank')} // Open page on click in a new tab
